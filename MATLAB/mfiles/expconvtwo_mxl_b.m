function pc=expconvtwo_mxl_b(inarg,intervals,tm,tx)
%
...
k2=abs(inarg(2));
a=(k1*k2)/(k2-k1);
probability_vector=(  1/( a*(exp(-tm*k1)-exp(-tx*k1)) + a*(exp(-tm*k2)-exp(-tx*k2)) )  )*...
                          ((a*k1)*((exp(-intervals*k1))-(a*k2)*(exp(-intervals*k2))));
