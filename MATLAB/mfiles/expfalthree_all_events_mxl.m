function pc=expfallthree_all_events_mxl(inarg,intervals,mxintervals,tm)
%
...
B=exp(-tm*tau2);
C=exp(-tm*tau3);
probability_vector1=(  1/( a1*A + (a2)*B + (1-a1-a2)*C  ) )*...
                                 ( a1*tau1*exp(-intervals*tau1)+(a2)*tau2*exp(-intervals*tau2)+(1-a1-a2)*tau3*exp(-intervals*tau3) );
probability_vector2=(  1/( a1*A + (a2)*B + (1-a1-a2)*C ) )*...
                                 ( a1*exp(-mxintervals*tau1)+(a2)*exp(-mxintervals*tau2)+(1-a1-a2)*exp(-mxintervals*tau3) );
