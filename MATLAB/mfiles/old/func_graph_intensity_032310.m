...
function graph=func_graph_intensity032310(file_path,header_path,min_frame,max_frame,spot_number,type)
...
%header_path= the path to a header file to use for the frames to time change. 
                ...
                %to be empty, where empty = ''   If you want time, set a header path.
