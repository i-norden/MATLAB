function graph=func_graph_intervals2(file_path,header_path,min_frame,max_frame,spot_number,silent)
%file_path= file path
...
func_graph_intervals_time_graph(graph,time2frames,-4,4,100,150,16);%100 and 150 shouldnt occur
