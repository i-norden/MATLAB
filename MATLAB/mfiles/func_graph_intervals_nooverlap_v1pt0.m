function graph=func_graph_intervals_nooverlap_v1pt0(file_path,header_path,min_frame,max_frame,spot_number,nodata,nopeak,peak,silent)
%file_path= file path
...
func_graph_intervals_time_graph(graph,time2frames,-4,4,100,150,16,nodata,nopeak,[0 0 0],[0 0 0],peak);%100 and 150 shouldnt occur
