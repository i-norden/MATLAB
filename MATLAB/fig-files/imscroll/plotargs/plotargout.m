...
% Last Modified by GUIDE v2.5 03-Oct-2011 17:11:34
...
switch ButtonChoiceValue
    ...
    eval( ['load ' [fp fn] ] );                    % Load the vid structure
...
if get(handles.CumulativeOperation,'Value')==1
   ...
   %[aoifitsFile AOINum UpThreshold DownThreshold  mean  std  MeanStdFrms DataFrms  TimeBase IntervalArray...
    ...
    if any( get(handles.CumulativeIntervalPopup,'Value')==[1] )        % Plot a detrended trace from the AllTracesCellAray
                                                                  % when popup set to Plot 
