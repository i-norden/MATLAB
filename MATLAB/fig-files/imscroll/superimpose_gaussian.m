function pc=superimpose_gaussian(fp,frames,folder,gamp,gsigma,xyRange,xyCenter,xyCenterRange)
%
% function pc=superimpose_gaussian(fp, frames, folder, gamp, gsigma, xyRange, xycenter, xyCenterRange)
%
...
pc=1;
            ...
            % frame
brightness=5:150;           % Range of spot brightness values we will test
